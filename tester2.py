# Sophia Masrour    sim7fv   ORIGINAL
...
description4 = gamebox.from_text(camera.x, camera.y + 150,  'PRESS THE SPACE BAR TO START', 25, 'red')
intro = [background, name, description1, description2, description3, description4]
